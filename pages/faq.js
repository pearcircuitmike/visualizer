      ...
      <Container mt={10} mb={10} maxW={"5xl"}>
        ...
        <Accordion allowToggle allowMultiple mt={10} mb={10}>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              <Text>
                People who think they have monkeypox or have had close personal
                contact with someone who has monkeypox should visit a healthcare
                provider to help them decide if they need to be tested for
                monkeypox. If they decide that you should be tested, they will
                work with you to collect the specimens and send them to a
            ...
            <AccordionPanel pb={4}>
              ...
              <ul>
                ...
                <li>
                  ...
                  like the hands, feet, chest, genitals, or anus. The rash goes
                  through different stages before healing completely. The
                  illness typically lasts 2-4 weeks.
                </li>
              </ul>
              <p>
                Sometimes, people get a rash first, followed by other symptoms.
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              You can view data for specific countries by visiting the countries
              tab in the navigation, or by clicking on a country with data on
              the map on the homepage. Note that not all countries have data at
              this time, and thus not all countries have detail pages. You can
              also use this link to travel to the{" "}
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              ...
              time, and thus not all states have detail pages. You can also use
              this link to travel to the{" "}
              <Link href="/states" aria-label="States" m={5} w="100%">
                <a style={{ color: `${colors.blueMunsell}` }}>states listing</a>
              </Link>{" "}
              page.
            </AccordionPanel>
          </AccordionItem>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              <Text>
                ...
                face-to-face contact, or during intimate physical contact, such
                as kissing, cuddling, or sex. Monkeypox can spread from the time
                symptoms start until the rash has fully healed and a fresh layer
                of skin has formed. Anyone in close personal contact with a
                person with monkeypox can get it and should take steps to
                protect themselves.
              </Text>
            </AccordionPanel>
          </AccordionItem>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              <Text>
                ...
                transmissible.” In other words, sex is just one of the ways that
                monkeypox can be spread. In the past, monkeypox outbreaks have
                been linked to direct exposure to infected animals and animal
                products, with limited person-to-person spread. In the current
                monkeypox outbreak, the virus is spreading primarily through
                close personal contact. This may include contact with infectious
                lesions or respiratory secretions via close, sustained
                skin-to-skin contact that occurs during sex. However, any close,
                sustained skin-to-skin contact with someone who has monkeypox
                can spread the virus. The contact does not have to be
                exclusively intimate or sexual.
              </Text>
            </AccordionPanel>
          </AccordionItem>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              <Text>
                ...
                materials that a person with monkeypox has used. Wash your hands
                often with soap and water or use an alcohol-based hand
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              <Text>
                ...
                close, personal, skin-to-skin contact is likely to occur there.
              </Text>
            </AccordionPanel>
          </AccordionItem>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              <Text>
                Because monkeypox and smallpox viruses are genetically similar,
                vaccines developed to protect against smallpox viruses may be
                used to prevent monkeypox infections. The U.S. government has
                two stockpiled vaccines—JYNNEOS and ACAM2000—that can prevent
                monkeypox in people who are exposed to the virus.
              </Text>
            </AccordionPanel>
          </AccordionItem>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              ...
              <ul>
                <li>
                  People who have been identified by public health officials as
                  a contact of someone with monkeypox
                </li>
                <li>
                ...
                <li>
                  People who had multiple sexual partners in the past 2 weeks in
                  an area with known monkeypox
                </li>
              </ul>
            </AccordionPanel>
          </AccordionItem>
